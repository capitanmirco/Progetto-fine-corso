...
<footer id="bottom" class=" blue row text-left p-4">
	<div class="col-12 col-md-4">
		...
		<div class="contatti">
			<p>automotivelis@gmail.com</p>
			 
			<p>+ 39 325 765 7899</p>
		 
			<p>+ 39 355 879 5285</p>
			
			<p>Via Sandro Sandri 45, Roma</p>
		 
			Siamo a tua disposizione, contattaci!</p>
		</div>
	...
	<div class="col-12 col-md-4">
		...
		<a href="https://it-it.facebook.com/login/"
			...
			src="https://iili.io/JnUjJj.png" class="social">
		</a> <a href="https://www.instagram.com/accounts/login/?"
			onclick="window.open(this.href);return false"> <img
			src="https://iili.io/JnUXUb.png" class="social">
		</a><a href="https://www.linkedin.com/"
			onclick="window.open(this.href);return false"> <img
			src="https://iili.io/JnUtst.png" class="social">
		</a> <a href="https://www.youtube.com/?hl=it&gl=IT"
			onclick="window.open(this.href);return false"> <img
			src="https://iili.io/JnU1xS.png" class="social" id="youtube">
		</a>
	</div>
