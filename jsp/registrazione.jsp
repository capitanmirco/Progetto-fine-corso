 ...
 <div class="container registra">
    <form method="post">
        ...
        <div class="form-group">
          ...
          <input type="text" required class="form-control" name="modello" id="inputModello" value="<%=a != null ? a.getModello() : "" %>">
     	  ...
     	  <div class="form-group">
            ...
            <input type="text" required class="form-control" name="cilindrata" id="inputCilindrata"<%=a != null ? a.getCilindrata() : "" %>>
          </div>
        ...
        <div class="form-group">
       		...
       		<input type="radio" id="radio1" name="categoria" value="1">
       		<label for="1">City car</label> &nbsp &nbsp
       		
       		<input type="radio" id="radio2" name="categoria" value="2" >
       		<label for="2">Suv</label> &nbsp &nbsp
       		
       		<input type="radio" id="radio3" name="categoria" value="3">    
